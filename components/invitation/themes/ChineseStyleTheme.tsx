...
function ChinesePersonCard({ photo, name, parents, bio, instagram, _P, _G, _TXT }: { photo?: string; name: string; parents?: string; bio?: string; instagram?: string; _P: string; _G: string; _TXT: string }) {
  return (
    <div className="space-y-3 text-center">
      <div
        className="mx-auto h-24 w-24 overflow-hidden rounded-full"
        style={{ border: `2.5px solid ${_G}` }}
      >
        {photo && (
          <WatermarkedImage src={photo} alt={name} width={96} height={96} className="h-full w-full object-cover" />
        )}
      </div>
      <h2 className="text-2xl font-bold" style={{ color: _P, fontFamily: "Cinzel, serif" }}>{name}</h2>
  ...
  switch (section.type) {
      ...
      return (
        ...
        >
          ...
          <div className="absolute inset-x-0 top-0 pointer-events-none">
            <div style={{ backgroundColor: _P, height: 7 }} />
            <CloudWave />
          ...
          <div className="relative z-10 px-8 py-24">
            ...
            <Anim variant="fadeIn" delay={140}>
              <p className="mb-4 text-[10px] tracking-[0.55em] uppercase" style={{ color: _P, opacity: 0.65 }}>
                — The Wedding of —
              </p>
            </Anim>
            ...
            <Anim variant="scaleIn" delay={380}>
              <p className="my-3 text-2xl font-light" style={{ color: _G }}>与</p>
            </Anim>
            ...
            <Anim variant="fadeIn" delay={620}>
              <div className="mt-5 h-px w-28 mx-auto" style={{ backgroundColor: _G, opacity: 0.45 }} />
              <p className="mt-3 text-sm tracking-widest" style={{ color: _P, opacity: 0.72 }}>
          ...
          {layout === "side-by-side" ? (
            <div className="flex justify-center gap-10">
              ...
              <Anim variant="scaleIn" delay={300} className="self-center">
                <span className="text-3xl font-light" style={{ color: _G }}>与</span>
              </Anim>
    ...
    case "event": {
      ...
      return (
        <section
          id={section.id}
          className="min-h-dvh flex flex-col items-center justify-center px-8 py-16 text-center"
          style={{ ...sectionStyle(section, `${_P}0d`) }}
        >
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-3">
                  {events.map((ev, i) => (
                    <div
                      ...
                      style={{ border: `2px solid ${_G}`, backgroundColor: `${_P}07` }}
                    >
                      <p
                      ...
                      {ev.time && (
                        <p className="text-sm opacity-65" style={{ color: _TXT }}>{ev.time}</p>
                      )}
                    </div>
                  ))}
                </div>
    ...
    case "quote":
      return (
        ...
        >
          <Anim variant="scaleIn" delay={0}>
            <p className="text-4xl leading-none" style={{ color: _G }}>&ldquo;</p>
          </Anim>
          <Anim variant="fadeUp" delay={160}>
            <blockquote
      ...
      return (
        ...
        >
          <div className="max-w-lg mx-auto w-full">
            ...
            {gmapsUrl && (
              <Anim variant="fadeUp" delay={150}>
                <div className="overflow-hidden rounded-lg" style={{ border: `2px solid ${_G}` }}>
                  <iframe
            ...
            {dirUrl && (
              <Anim variant="fadeUp" delay={380}>
                <a
                  ...
                  style={{ border: `2px solid ${_P}`, color: _P }}
                >
    ...
    case "closing":
      return (
        ...
        >
          ...
          <Anim variant="fadeUp" delay={200}>
            <p className="mx-auto max-w-xs text-base leading-relaxed mt-4" style={{ color: _TXT, opacity: 0.72 }}>
              {(c.message as string) ||
                "Merupakan suatu kehormatan dan kebahagiaan bagi kami apabila Anda berkenan hadir."}
            </p>
          </Anim>
          <Anim variant="scaleIn" delay={380}>
            <div className="mt-6 h-px w-24 mx-auto" style={{ backgroundColor: _G, opacity: 0.5 }} />
          </Anim>
          <Anim variant="fadeIn" delay={460}>
            <p className="mt-4 text-xl font-bold" style={{ color: _P, fontFamily: "Cinzel, serif" }}>
          ...
          <div className="columns-2 gap-2 px-4 w-full max-w-sm mx-auto">
            {images.map((url, i) => (
              <div
                ...
                style={{ border: `1.5px solid ${_G}50` }}
              >
                <WatermarkedImage
  ...
  return (
    <>
      {sorted.map((section) => (
        ...
        >
          <ChineseSection section={section} inv={inv} _P={tc.primary} _G={tc.accent} _BG={tc.bg} _TXT={tc.text} _BORDER={tc.border} />
        </div>
      ))}
    </>
  )
