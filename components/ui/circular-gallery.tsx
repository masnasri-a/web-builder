...
/**
 * CircularGallery — adapted from ReactBits (https://reactbits.dev/components/circular-gallery)
 * Uses OGL for WebGL rendering with curved, scrollable image gallery.
 */
